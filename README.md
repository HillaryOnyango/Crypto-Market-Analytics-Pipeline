...
This project implements a modern ELT (Extract–Load–Transform) data pipeline for cryptocurrency market analytics. It ingests real-time market data from the Binance API, stores raw data in PostgreSQL, transforms it using dbt, and visualizes insights in Grafana.
...
Data is fetched from the Binance public REST API:
